...
SK_C_API void sk_canvas_draw_custom(sk_canvas_t* ccanvas, sk_custom_element_t* element, sk_paint_t* cpaint);
SK_C_API void sk_canvas_draw_paint(sk_canvas_t*, const sk_paint_t*);
SK_C_API void sk_canvas_draw_paint_wa(sk_canvas_t* ccanvas, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_rect(sk_canvas_t*, const sk_rect_t*, const sk_paint_t*);
SK_C_API void sk_canvas_draw_rect_wa(sk_canvas_t* ccanvas, const sk_rect_t* crect, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_rrect(sk_canvas_t*, const sk_rrect_t*, const sk_paint_t*);
SK_C_API void sk_canvas_draw_rrect_wa(sk_canvas_t* ccanvas, const sk_rrect_t* crect, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_region(sk_canvas_t*, const sk_region_t*, const sk_paint_t*);
SK_C_API void sk_canvas_draw_region_wa(sk_canvas_t* ccanvas, const sk_region_t* cregion, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_circle(sk_canvas_t*, float cx, float cy, float rad, const sk_paint_t*);
SK_C_API void sk_canvas_draw_circle_wa(sk_canvas_t* ccanvas, float cx, float cy, float rad, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_oval(sk_canvas_t*, const sk_rect_t*, const sk_paint_t*);
SK_C_API void sk_canvas_draw_oval_wa(sk_canvas_t* ccanvas, const sk_rect_t* crect, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_path(sk_canvas_t*, const sk_path_t*, const sk_paint_t*);
SK_C_API void sk_canvas_draw_path_wa(sk_canvas_t* ccanvas, const sk_path_t* cpath, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_image(sk_canvas_t*, const sk_image_t*, float x, float y, const sk_paint_t*);
SK_C_API void sk_canvas_draw_image_wa(sk_canvas_t* ccanvas, const sk_image_t* cimage, float x, float y, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_image_rect_wa(sk_canvas_t* ccanvas, const sk_image_t* cimage, const sk_rect_t* csrcR, const sk_rect_t* cdstR, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_picture(sk_canvas_t*, const sk_picture_t*, const sk_matrix_t*, const sk_paint_t*);
SK_C_API void sk_canvas_draw_picture_wa(sk_canvas_t* ccanvas, const sk_picture_t* cpicture, const sk_matrix_t* cmatrix, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_drawable(sk_canvas_t*, sk_drawable_t*, const sk_matrix_t*);
SK_C_API void sk_canvas_draw_drawable_wa(sk_canvas_t* ccanvas, sk_drawable_t* cdrawable, const sk_matrix_t* cmatrix, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_color_wa(sk_canvas_t* ccanvas, sk_color_t color, sk_blendmode_t cmode, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_points(sk_canvas_t*, sk_point_mode_t, size_t, const sk_point_t[], const sk_paint_t*);
SK_C_API void sk_canvas_draw_points_wa(sk_canvas_t* ccanvas, sk_point_mode_t pointMode, size_t count, const sk_point_t points [], const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_point(sk_canvas_t*, float, float, const sk_paint_t*);
SK_C_API void sk_canvas_draw_point_wa(sk_canvas_t* ccanvas, float x, float y, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_line(sk_canvas_t* ccanvas, float x0, float y0, float x1, float y1, sk_paint_t* cpaint);
SK_C_API void sk_canvas_draw_line_wa(sk_canvas_t* ccanvas, float x0, float y0, float x1, float y1, sk_paint_t* cpaint, const char* attrName, const char* attrVal);
SK_C_API void sk_canvas_draw_text (sk_canvas_t*, const char* text, size_t byteLength, float x, float y, const sk_paint_t* paint);
SK_C_API void sk_canvas_draw_text_wa(sk_canvas_t* ccanvas, const char *text, size_t byteLength, float x, float y, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_pos_text_wa(sk_canvas_t* ccanvas, const char *text, size_t byteLength, const sk_point_t pos[], const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_text_on_path_wa(sk_canvas_t* ccanvas, const char *text, size_t byteLength, const sk_path_t* path, float hOffset, float vOffset, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_bitmap_rect_wa(sk_canvas_t* ccanvas, const sk_bitmap_t* cbitmap, const sk_rect_t* csrcR, const sk_rect_t* cdstR, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_round_rect_wa(sk_canvas_t* ccanvas, const sk_rect_t* crect, float rx, float ry, const sk_paint_t* cpaint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_vertices_wa(sk_canvas_t* ccanvas, const sk_vertices_t* vertices, sk_blendmode_t mode, const sk_paint_t* paint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_arc_wa(sk_canvas_t* ccanvas, const sk_rect_t* oval, float startAngle, float sweepAngle, bool useCenter, const sk_paint_t* paint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_drrect_wa(sk_canvas_t* ccanvas, const sk_rrect_t* outer, const sk_rrect_t* inner, const sk_paint_t* paint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_atlas_wa(sk_canvas_t* ccanvas, const sk_image_t* atlas, const sk_rsxform_t* xform, const sk_rect_t* tex, const sk_color_t* colors, int count, sk_blendmode_t mode, const sk_rect_t* cullRect, const sk_paint_t* paint, const char* attrName, const char* attrVal);
...
SK_C_API void sk_canvas_draw_patch_wa(sk_canvas_t* ccanvas, const sk_point_t* cubics, const sk_color_t* colors, const sk_point_t* texCoords, sk_blendmode_t mode, const sk_paint_t* paint, const char* attrName, const char* attrVal);
